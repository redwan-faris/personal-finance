...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Wallet</h1>
            <p class="mt-2 text-sm text-gray-700">Update wallet information and settings.</p>
        </div>
            ...
            <form action="{{ route('wallets.update', $wallet) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="user_id" id="user_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('user_id') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="balance" id="balance" step="0.01" value="{{ old('balance', $wallet->balance) }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  ...
                                  placeholder="Optional description for this wallet">{{ old('description', $wallet->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
